...
class BooksTestCase(TestCase):
    ...
    def test_books_list(self):
        book1 = Book.objects.create(
            title="Book1", description="Description1", isbn=123121
        )
        book2 = Book.objects.create(
            title="Book2", description="Description2", isbn=222222
        )
        book3 = Book.objects.create(
            title="Book3", description="Description3", isbn=333333
        )
    ...
    def test_search_books(self):
        book1 = Book.objects.create(
            title="Sport", description="Description1", isbn=123121
        )
        book2 = Book.objects.create(
            title="Guide", description="Description2", isbn=222222
        )
        book3 = Book.objects.create(
            title="Shoe Dog", description="Description3", isbn=333333
        )
